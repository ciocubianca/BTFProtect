       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-6 offer"><!-- col-md-6 offer Begin -->
               ...
               <a href="#" class="btn btn-success">
                   ...
                   if(!isset($_SESSION['customer_email'])){
                       ...
                       echo "Bine ai venit, " . $_SESSION['customer_email'] . "";
               ...
               <a href="checkout.php"><?php items(); ?> Produse în coș | Preț total: <?php total_price(); ?> </a>
           ...
           <div class="col-md-6"><!-- col-md-6 Begin -->
               ...
               <ul class="menu"><!-- cmenu Begin -->
                   ...
                   <li>
                       <a href="customer_register.php">Cont nou</a>
                   </li>
                   <li>
                   ...
                   <li>
                       <a href="checkout.php">
                           ...
                           if(!isset($_SESSION['customer_email'])){
                                ...
                                echo " <a href='logout.php'> Deconectează-te </a> ";
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/logobtf.png" alt="BTF Protect Logo" width = "90%" class="hidden-xs">
                   <img src="images/logobtf.png" alt="BTF Protect Logo Mobile" width = "50%" class="visible-xs">
           ...
           <div class="navbar-collapse collapse" id="navigation"><!-- navbar-collapse collapse Begin -->
               ...
               <a href="cart.php" class="btn navbar-btn btn-primary right"><!-- btn navbar-btn btn-primary Begin -->
                   ...
                   <span><?php items(); ?> Produse în coș</span>
           ...
           <div id="cart" class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <form action="cart.php" method="post" enctype="multipart/form-data"><!-- form Begin -->
                       ...
                       <p class="text-muted">Ai <?php echo $count; ?> produse în coșul tău</p>
                       ...
                       <div class="table-responsive"><!-- table-responsive Begin -->
                           ...
                           <table class="table"><!-- table Begin -->
                               ...
                               <tfoot><!-- tfoot Begin -->
                                   ...
                                   <tr><!-- tr Begin -->
                                       ...
                                       <th colspan="1"><?php echo $total; ?> lei</th>
                           ...
                           <div class="form-inline pull-right"><!-- form-inline Begin -->
                               <div class="form-group"><!-- form-group Begin -->
                                    ...
                                    <input type="submit" class="btn btn-primary" value="Aplică cupon" name="apply_coupon">
                       ...
                       <div class="box-footer"><!-- box-footer Begin -->
                           ...
                           <div class="pull-left"><!-- pull-left Begin -->
                               ...
                               <a href="shop.php" class="btn btn-default"><!-- btn btn-default Begin -->
                                   ...
                                   <i class="fa fa-chevron-left"></i> Continuă cumpărăturile
                           ...
                           <div class="pull-right"><!-- pull-right Begin -->
                               ...
                               <a href="checkout.php" class="btn btn-primary">
                                   ...
                                   Continuă <i class="fa fa-chevron-right"></i>
                ...
                if($code == ""){
                    ...
                    if($check_coupons == "1"){
                        ...
                        if($coupon_limit == $coupon_used){
                            ...
                            echo "<script>alert('Cuponul tău a expirat!')</script>";
                            ...
                            if($check_cart == "1"){
                                ...
                                echo "<script>alert('Cuponul a fost aplicat!')</script>";
                                echo "<script>window.open('cart.php','_self')</script>";

                            }else{

                                echo "<script>alert('Cuponul nu se potrivește cu produsul!')</script>";
                        ...
                        echo "<script>alert('Cuponul tău nu este valid!')</script>";
               ...
               <div id="row same-heigh-row"><!-- #row same-heigh-row Begin -->
                   <div class="col-md-3 col-sm-6"><!-- col-md-3 col-sm-6 Begin -->
                       <div class="box same-height headline"><!-- box same-height headline Begin -->
                           <h3 class="text-center">Produse care ți-ar putea plăcea</h3>
