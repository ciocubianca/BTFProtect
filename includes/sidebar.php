    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Begin -->
        ...
        <div class="panel-body"><!-- panel-body 1 Begin -->
            <div class="input-group"><!-- input-group Begin -->
                <input type="text" class="form-control" id="dev-table-filter" data-filters="#dev-manufacturer" data-action="filter" placeholder="Caută gama dorită">
...
<div class="panel panel-default sidebar-menu"><!-- panel panel-default sidebar-menu Begin -->
    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Begin -->
        ...
        <div class="panel-body"><!-- panel-body 1 Begin -->
            <div class="input-group"><!-- input-group Begin -->
                <input type="text" class="form-control" id="dev-table-filter" data-filters="#dev-cat" data-action="filter" placeholder="Caută încălțămintea dorită">
...
<div class="panel panel-default sidebar-menu"><!-- panel panel-default sidebar-menu Begin -->
    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Begin -->
        ...
        <div class="panel-body"><!-- panel-body 1 Begin -->
            <div class="input-group"><!-- input-group Begin -->
                <input type="text" class="form-control" id="dev-table-filter" data-filters="#dev-p-cat" data-action="filter" placeholder="Caută îmbrăcămintea dorită">
