...
<h1 align="center"> Modifică datele contului </h1>
...
<form action="" method="post" enctype="multipart/form-data"><!-- form Begin -->
    ...
    <div class="text-center"><!-- text-center Begin -->
        ...
        <button name="update" class="btn btn-primary"><!-- btn btn-primary Begin -->
            ...
            <i class="fa fa-user-md"></i> Modifică
...
if(isset($_POST['update'])){
    ...
    if($run_customer){
        ...
        echo "<script>alert('Datele au fost editate cu succes. Pentru a vedea modificările, te rugăm să te reconectezi cu noile date.')</script>";
