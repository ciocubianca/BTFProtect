<div class="box"><!-- box Begin -->
  ...
  <div class="box-header"><!-- box-header Begin -->
      <center><!-- center Begin -->
          ...
          <p class="lead"> Intră în contul tău </p>
  ...
  <center><!-- center Begin -->
     ...
     <a href="customer_register.php">
         ...
         <h3> Nu ai un cont? Înregistrează-te aici </h3>
...
if(isset($_POST['login'])){
    ...
    if($check_customer==0){
        ...
        echo "<script>alert('Email-ul sau parola ta este greșită!')</script>";
    ...
    if($check_customer==1 AND $check_cart==0){
       ...
       echo "<script>alert('Te-ai autentificat cu succes!')</script>"; 
