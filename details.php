                   ...
                   <div class="col-sm-6"><!-- col-sm-6 Begin -->
                       <div class="box"><!-- box Begin -->
                           ...
                           <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               ...
                               <div class="form-group"><!-- form-group Begin -->
                                   <label class="col-md-5 control-label">Marime</label>
                                   ...
                                   <div class="col-md-7"><!-- col-md-7 Begin -->
                                       ...
                                       <select name="product_size" class="form-control" required oninput="setCustomValidity('')" oninvalid="setCustomValidity('Must pick 1 size for the product')"><!-- form-control Begin -->
                                           ...
                                           <option disabled selected>Selectează mărimea</option>
                                           <option>Small</option>
                               ...
                               <?php 
                                    ...
                                    if($pro_label == "sale"){
                                        ...
                                        echo "
                                            ...
                                            Preț întreg: <del> $pro_price</del> lei<br/>

                                            Preț redus:     $pro_sale_price lei
                               ...
                               <p class="text-center buttons"><button class="btn btn-primary i fa fa-shopping-cart"> Adaugă în coș</button></p>
